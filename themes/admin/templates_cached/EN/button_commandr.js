...
{img.src='http://csm.transworldinteractive.net/themes/default/images/icons/24x24/tool_buttons/commandr_off.png'.replace(/^https?:/,window.location.protocol);if(typeof img.srcset!='undefined')
img.srcset='http://csm.transworldinteractive.net/themes/default/images/icons/48x48/tool_buttons/commandr_off.png 2x'.replace(/^https?:/,window.location.protocol);img.className='';}
...
{if(img)
{img.src='http://csm.transworldinteractive.net/themes/default/images/icons/24x24/tool_buttons/commandr_on.png'.replace(/^https?:/,window.location.protocol);if(typeof img.srcset!='undefined')
img.srcset='http://csm.transworldinteractive.net/themes/default/images/icons/48x48/tool_buttons/commandr_on.png 2x'.replace(/^https?:/,window.location.protocol);set_opacity(img,1.0);}
