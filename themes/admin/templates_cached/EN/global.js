...
{if(window.page_loaded)return;var i;if(window==window.top&&!window.opener||window.name=='')window.name='_site_opener';if(typeof document.documentElement.ontouchstart!='undefined')document.body.className+=' touch_enabled';var preloader=new Image();var images=[];images.push('http://csm.transworldinteractive.net/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol));for(i=0;i<images.length;i++)preloader.src=images[i];handle_textarea_scrolling();if((!window.parent)||(window.parent==window))
...
if(read_cookie('hide_helper_panel')=='1')set_cookie('hide_helper_panel','0',100);helper_panel_toggle.onclick=function(){return helper_panel(false);};helper_panel_toggle.childNodes[0].src='http://csm.transworldinteractive.net/themes/default/images/icons/14x14/helper_panel_hide.png'.replace(/^https?:/,window.location.protocol);if(typeof helper_panel_toggle.childNodes[0].srcset!='undefined')
helper_panel_toggle.childNodes[0].srcset='http://csm.transworldinteractive.net/themes/default/images/icons/28x28/helper_panel_hide.png 2x'.replace(/^https?:/,window.location.protocol);}else
...
{panel_right.className+=' helper_panel_hidden';helper_panel_contents.setAttribute('aria-expanded','false');helper_panel_contents.style.display='none';set_cookie('hide_helper_panel','1',100);helper_panel_toggle.onclick=function(){return helper_panel(true);};helper_panel_toggle.childNodes[0].src='http://csm.transworldinteractive.net/themes/default/images/icons/14x14/helper_panel_show.png'.replace(/^https?:/,window.location.protocol);if(typeof helper_panel_toggle.childNodes[0].srcset!='undefined')
helper_panel_toggle.childNodes[0].srcset='http://csm.transworldinteractive.net/themes/default/images/icons/28x28/helper_panel_show.png 2x'.replace(/^https?:/,window.location.protocol);}
function sts(src)
...
if(pic)
{if(matches_theme_image(pic.src,'http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon.png'))return false;if(matches_theme_image(pic.src,'http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon2.png'))return false;}
...
{set_tray_theme_image(pic,'expand','expcon','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expcon.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon2.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expcon2.png');}
...
if(pic)
{set_tray_theme_image(pic,'expand','contract','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/contract.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract2.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/contract2.png');}}}else
{if((type=='block')&&(element.nodeName.toLowerCase()=='div')&&(!no_animate)&&((!pic)||(pic.src.indexOf('themewizard.php')==-1)))
{if(pic)
{set_tray_theme_image(pic,'contract','expcon','http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expcon.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon2.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expcon2.png');}
window.setTimeout(function(){begin_toggleable_tray_animation(element,-20,70,0,pic);},20);}else
{if(pic)
{set_tray_theme_image(pic,'contract','expand','http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expand.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand2.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expand2.png');pic.setAttribute('alt',pic.getAttribute('alt').replace('Contract','Expand'));pic.title='Expand';pic.cms_tooltip_title='Expand';}
...
{if(animate_dif<0)
{set_tray_theme_image(pic,'expcon','expand','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expand.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand2.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/expand2.png');}else
{set_tray_theme_image(pic,'expcon','contract','http://csm.transworldinteractive.net/themes/default/images/1x/trays/expcon.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/contract.png','http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract2.png','http://csm.transworldinteractive.net/themes/default/images/2x/trays/contract2.png');}
...
{return read_cookie('cms_session__c55660b62636c25acb9b5b956248713f');}
...
var _replace_spot=(template=='')?bit.parentNode.parentNode.parentNode.parentNode:replace_spot;set_inner_html(_replace_spot,'');var loading_image=document.createElement('img');loading_image.className='ajax_loading';loading_image.src='http://csm.transworldinteractive.net/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);loading_image.style.height='12px';_replace_spot.appendChild(loading_image);var snippet_request='rating&type='+window.encodeURIComponent(type)+'&id='+window.encodeURIComponent(id)+'&content_type='+window.encodeURIComponent(content_type)+'&template='+window.encodeURIComponent(template)+'&content_url='+window.encodeURIComponent(content_url)+'&content_title='+window.encodeURIComponent(content_title);var message=load_snippet(snippet_request,'rating='+window.encodeURIComponent(i),function(ajax_result){var message=ajax_result.responseText;set_outer_html(_replace_spot,(template=='')?('<strong>'+message+'</strong>'):message);});return false;}}(i);}}}
...
post+='&post='+window.encodeURIComponent(post_value);do_ajax_request('http://csm.transworldinteractive.net/data/post_comment.php'+keep_stub(true),function(ajax_result){if((ajax_result.responseText!='')&&(ajax_result.status!=500))
...
{form.elements['submit_button'].disabled=true;var url='http://csm.transworldinteractive.net/data/snippet.php?snippet=captcha_wrong&name='+window.encodeURIComponent(form.elements['captcha'].value);if(!do_ajax_field_test(url))
