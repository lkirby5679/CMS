"use strict";new Image().src='http://csm.transworldinteractive.net/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);function password_strength(ob)
...
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('expand','contract'):'http://csm.transworldinteractive.net/themes/default/images/1x/trays/contract.png').replace(/^https?:/,window.location.protocol);if(typeof pic.srcset!='undefined')
pic.srcset=((pic.srcset.indexOf('themewizard.php')!=-1)?pic.srcset.replace('expand','contract'):'http://csm.transworldinteractive.net/themes/default/images/2x/trays/contract.png 2x').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Contract');pic.setAttribute('title','Contract');new_state=(field_input.nodeName.toLowerCase()=='tr')?'table-row':'block';new_state_2='block';new_state_3='1px dashed';}else
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('contract','expand'):'http://csm.transworldinteractive.net/themes/default/images/1x/trays/expand.png').replace(/^https?:/,window.location.protocol);if(typeof pic.srcset!='undefined')
pic.srcset=((pic.src.indexOf('themewizard.php')!=-1)?pic.srcset.replace('contract','expand'):'http://csm.transworldinteractive.net/themes/default/images/2x/trays/expand.png 2x').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Expand');pic.setAttribute('title','Expand');new_state='none';new_state_2='none';new_state_3='0';}
...
{try
{navigator.geolocation.getCurrentPosition(function(position){var fields=['Address: Street address','Address: Town/City','Address: County','Address: State','Address: Postcode/Zip','Address: Country'];var geocode_url='http://csm.transworldinteractive.net/data/geocode.php';geocode_url+='?latitude='+window.encodeURIComponent(position.coords.latitude)+'&longitude='+window.encodeURIComponent(position.coords.longitude);geocode_url+=keep_stub();do_ajax_request(geocode_url,function(ajax_result){var parsed=JSON.parse(ajax_result.responseText);if(parsed===null)return;var labels=document.getElementsByTagName('label'),label,field_name,field;for(var i=0;i<labels.length;i++)
