...
{url_stub+=(url_stem.indexOf('?')==-1)?'?':'&';url_stub+=matches[1]+'='+matches[2];url_stub+='&raw=1';window.infinite_scroll_pending=true;return call_block(url_stem+url_stub,'',wrapper_inner,true,function(){window.infinite_scroll_pending=false;internalise_infinite_scrolling(url_stem,wrapper,true);});}}}
return false;}
...
var loading_image=document.createElement('img');loading_image.className='ajax_loading_block';loading_image.src='http://csm.transworldinteractive.net/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);loading_image.style.position='absolute';loading_image.style.zIndex='1000';loading_image.style.left=(find_width(target_div)/2-10)+'px';if(!append)
