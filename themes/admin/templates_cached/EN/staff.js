...
contextual_css_edit();window.setTimeout(contextual_css_edit,2000);var url_patterns=[{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=authors&type=browse&id=([^&]*)/,hook:'author'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-authors&type=_add&id=([^&]*)/,hook:'author'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=banners&type=view&source=([^&]*)/,hook:'banner'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-banners&type=_edit&id=([^&]*)/,hook:'banner'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=calendar&type=browse&id=([^&]*)/,hook:'calendar_type'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-calendar&type=_edit_category&id=([^&]*)/,hook:'calendar_type'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=catalogues&type=category&id=([^&]*)/,hook:'catalogue_category'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-catalogues&type=_edit_category&id=([^&]*)/,hook:'catalogue_category'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=catalogues&type=entry&id=([^&]*)/,hook:'catalogue_entry'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-catalogues&type=_edit&id=([^&]*)/,hook:'catalogue_entry'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=catalogues&type=index&id=([^&]*)/,hook:'catalogue'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-catalogues&type=_edit_catalogue&id=([^&]*)/,hook:'catalogue'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=chat&type=room&id=([^&]*)/,hook:'chat'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-chat&type=room&id=([^&]*)/,hook:'chat'},{pattern:/^http:\/\/csm.transworldinteractive.net\/([^&]*)\/?index.php\?page=-WILD/,hook:'comcode_page'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-comcode-pages&type=_edit&page_link=([^&]*)/,hook:'comcode_page'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=downloads&type=browse&id=([^&]*)/,hook:'download_category'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-downloads&type=_edit_category&id=([^&]*)/,hook:'download_category'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=downloads&type=entry&id=([^&]*)/,hook:'download'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-downloads&type=_edit&id=([^&]*)/,hook:'download'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=calendar&type=view&id=([^&]*)/,hook:'event'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-calendar&type=_edit&id=([^&]*)/,hook:'event'},{pattern:/^http:\/\/csm.transworldinteractive.net\/forum\/index.php\?page=forumview&type=browse&id=([^&]*)/,hook:'forum'},{pattern:/^http:\/\/csm.transworldinteractive.net\/adminzone\/index.php\?page=admin-cns-forums&type=_edit_category&id=([^&]*)/,hook:'forum'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=galleries&type=browse&id=([^&]*)/,hook:'gallery'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-galleries&type=_edit_category&id=([^&]*)/,hook:'gallery'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=groups&type=view&id=([^&]*)/,hook:'group'},{pattern:/^http:\/\/csm.transworldinteractive.net\/adminzone\/index.php\?page=admin-cns-groups&type=_edit&id=([^&]*)/,hook:'group'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=galleries&type=image&id=([^&]*)/,hook:'image'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-galleries&type=_edit&id=([^&]*)/,hook:'image'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=members&type=view&id=([^&]*)/,hook:'member'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=news&type=browse&id=([^&]*)/,hook:'news_category'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-news&type=_edit_category&id=([^&]*)/,hook:'news_category'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=news&type=view&id=([^&]*)/,hook:'news'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-news&type=_edit&id=([^&]*)/,hook:'news'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=polls&type=view&id=([^&]*)/,hook:'poll'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-polls&type=_edit&id=([^&]*)/,hook:'poll'},{pattern:/^http:\/\/csm.transworldinteractive.net\/forum\/index.php\?page=topicview&type=findpost&id=([^&]*)/,hook:'post'},{pattern:/^http:\/\/csm.transworldinteractive.net\/forum\/index.php\?page=topics&type=edit_post&id=([^&]*)/,hook:'post'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=quiz&type=do&id=([^&]*)/,hook:'quiz'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-quiz&type=_edit&id=([^&]*)/,hook:'quiz'},{pattern:/^http:\/\/csm.transworldinteractive.net\/forum\/index.php\?page=topicview&type=browse&id=([^&]*)/,hook:'topic'},{pattern:/^http:\/\/csm.transworldinteractive.net\/forum\/index.php\?page=topics&type=edit_topic&id=([^&]*)/,hook:'topic'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=galleries&type=video&id=([^&]*)/,hook:'video'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-galleries&type=_edit_other&id=([^&]*)/,hook:'video'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=wiki&type=browse&id=([^&]*)/,hook:'wiki_page'},{pattern:/^http:\/\/csm.transworldinteractive.net\/cms\/index.php\?page=cms-wiki&type=edit_page&id=([^&]*)/,hook:'wiki_page'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=wiki&type=find_post&id=([^&]*)/,hook:'wiki_post'},{pattern:/^http:\/\/csm.transworldinteractive.net\/site\/index.php\?page=wiki&type=post&post_id=([^&]*)/,hook:'wiki_post'}];var cells=document.getElementsByTagName('td');var links=[];if(window.location.href.replace('','').indexOf('/cms/')!=-1)
...
{cancel_bubbling(event);if(typeof event.preventDefault!='undefined')event.preventDefault();ob.edit_window=window.open('http://csm.transworldinteractive.net/adminzone/index.php?page=admin_themes&type=edit_image&lang='+window.encodeURIComponent(window.cms_lang)+'&theme='+window.encodeURIComponent(window.cms_theme)+'&url='+window.encodeURIComponent(src.replace('http://csm.transworldinteractive.net/',''))+keep_stub(),'edit_theme_image_'+ob.id);}
...
{url+=window.encodeURIComponent('Transworld Interactive'.replace(/[^a-zA-Z0-9\_\-\\\[\]{}\^`|]/g,''));}
...
{new Image().src='http://csm.transworldinteractive.net/themes/default/images/checklist/cross2.png';new Image().src='http://csm.transworldinteractive.net/themes/default/images/checklist/toggleicon2.png';var checklist_rows=get_elements_by_class_name(document,'checklist_row'),row_imgs,src;for(var i=0;i<checklist_rows.length;i++)
...
{load_snippet('checklist_task_manage','type=mark_done&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_undone(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','http://csm.transworldinteractive.net/themes/default/images/checklist/checklist1.png');}
function mark_undone(ob,id)
{load_snippet('checklist_task_manage','type=mark_undone&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_done(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','http://csm.transworldinteractive.net/themes/default/images/checklist/not_completed.png');}
