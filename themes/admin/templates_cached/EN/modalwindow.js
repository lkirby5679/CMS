...
{if(typeof start=='undefined')start=0;var modal=_open_image_into_lightbox(imgs[start][0],imgs[start][1],start+1,imgs.length,true,imgs[start][2]);modal.positionInSet=start;var previous_button=document.createElement('img');previous_button.className='previous_button';previous_button.src='http://csm.transworldinteractive.net/themes/default/images/mediaset_previous.png'.replace(/^https?:/,window.location.protocol);var previous=function(e){if(typeof e=='undefined')e=window.event;cancel_bubbling(e);var new_position=modal.positionInSet-1;if(new_position<0)new_position=imgs.length-1;modal.positionInSet=new_position;_open_different_image_into_lightbox(modal,new_position,imgs);return false;};previous_button.onclick=previous;modal.left=previous;modal.box_wrapper.childNodes[0].appendChild(previous_button);var next_button=document.createElement('img');next_button.className='next_button';next_button.src='http://csm.transworldinteractive.net/themes/default/images/mediaset_next.png'.replace(/^https?:/,window.location.protocol);var next=function(e){if(typeof e=='undefined')e=window.event;cancel_bubbling(e);var new_position=modal.positionInSet+1;if(new_position>=imgs.length)new_position=0;modal.positionInSet=new_position;_open_different_image_into_lightbox(modal,new_position,imgs);return false;};next_button.onclick=next;modal.right=next;modal.box_wrapper.childNodes[0].appendChild(next_button);}
...
{if(typeof has_full_button=='undefined')has_full_button=false;var lightbox_code=' \
   <div style="text-align: center"> \
    <p class="ajax_loading" id="lightbox_image"><img src="'+'http://csm.transworldinteractive.net/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol)+'" /></p> \
...
{button=this.element('img',{'src':'http://csm.transworldinteractive.net/themes/default/images/button_lightbox_close.png'.replace(/^https?:/,window.location.protocol),'alt':this.cancel_button,'class':'overlay_close_button'});container.appendChild(button);}
